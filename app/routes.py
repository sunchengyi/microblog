...
def explore():
    ...
    prev_url = url_for('explore', page=posts.prev_num) \
        if posts.has_prev else None
    return render_template('index.html', title='Explort', posts=posts.items,
...
def edit_profile():
    ...
    return render_template('edit_profile.html', tile='Edit Profile', form=form)
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Check your email for the instructions to resett your password')
        return redirect(url_for('login'))
