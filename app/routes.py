...
def explore():
    ...
    prev_url = url_for('explore', page=posts.prev_num) \
        if posts.has_prev else None
    return render_template('index.html', title=_('Explort'), posts=posts.items,
...
def register():
    ...
    if form_register.validate_on_submit():
        ...
        return redirect(url_for('index'))
    return render_template('register.html', title=_('Register'), form=form_register)

@app.route('/user/<username>')
@login_required
def user(username):
    """
    The profile view of user.
    """
    ...
    return render_template('user.html', user=user, posts=posts.items, 
                           next_url=next_url, prev_url=prev_url, form1=form)
...
def edit_profile():
    ...
    return render_template('edit_profile.html', tile=_('Edit Profile'), form=form)
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash(_('Check your email for the instructions to resett your password'))
        return redirect(url_for('login'))
